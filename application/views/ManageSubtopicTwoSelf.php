...
<div class="container mt-3">
    <table class="table table-form">
        <tr>
            <th class="topic-background mit border">Copy Subtopics of subtopics of the Main Topic From</th>
    ...
    <table class="table table-form border-0">
        <tr>
            ...
            <th class="border-0" style="width: 300px;">
                ...
                <input type="text" name="s_sub_in_sub" id="s_sub_in_sub" class="form-control" value="<?php echo $s_sub_in_sub ?>">
            </th>
        </tr>
        <tr>
            <th class="border-0">
        ...
        <tr>
            ...
            <th class="border-0 text-end align-bottom">
                ...
                <button class="btn btn-primary btn_color_df" onclick="claer_search_Subtopics_of_subtopics();">Clear</button>
            </th>
        </tr>
    </table>
</div>
