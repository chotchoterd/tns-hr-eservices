...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td class="border-0"><b>คำแนะนำ:</b> กรุณาประเมินประสิทธิภาพการทำงานของคุณอย่างครบถ้วนเพื่อแสดงให้เห็นถึงผลสำเร็จตามเป้าหมายงานของคุณในปีนี้  (' . $current_year . '). และความมุ่งมั่นอย่างต่อเนื่องของคุณในการปรับปรุงประสิทธิภาพการทำงานของคุณภายในองค์กรและเป้าหมายงานของคุณในปีถัดไป (' . ($current_year + 1) . '). ให้เสร็จสิ้นภายในวันที่ 30 ตุลาคม ' . $current_year . '</td>';
$html .= '</tr>';
$html .= '</table>';
$html .= '<table>';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th align="left" style="border: 1px solid #000000; width: 100px;">Employee name <br> ชื่อ-นามสกุล</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000; width: 150px;">';
$html .= '' . $self_evaluation_ids->emp_name . '';
$html .= '</td>';
$html .= '<th align="left" style="border: 1px solid #000000; width: 90px;">Employee ID <br> เลขที่พนักงาน</th>';
$html .= '<td style="border: 1px solid #000000; width: 100px;">';
$html .= '' . $self_evaluation_ids->emp_id . '';
$html .= '</td>';
$html .= '<th align="left" style="border: 1px solid #000000;">Employee Grade <br> เกรดพนักงาน</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->emp_grade . '';
$html .= '</td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th align="left" style="border: 1px solid #000000;">Position <br> ตำแหน่ง</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->position . '';
$html .= '</td>';
$html .= '<th align="left" style="border: 1px solid #000000;">Section <br> แผนก</th>';
$html .= '<td style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->section . '';
$html .= '</td>';
$html .= '<th align="left" style="border: 1px solid #000000;">Hired date <br> วันเริ่มงาน</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->hired_date . '';
$html .= '</td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th align="left" style="border: 1px solid #000000;">Division <br> ฝ่ายงาน</th>';
$html .= '<td colspan="3" style="border: 1px solid #000000; width: 150px">';
$html .= '' . $self_evaluation_ids->division . '';
$html .= '</td>';
$html .= '<th colspan="2" align="left" style="border: 1px solid #000000;">Employee Years of service</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->emp_year_of_service . '';
$html .= '</td>';
$html .= '</tr>';
$html .= '<div style="' . ($self_evaluation_ids->sup_name == "" ? "display: none;" : "") . '">';
$html .= '<tr>';
$html .= '<th colspan="2" align="left" style="border: 1px solid #000000;">Supervisor name 1 <br> ชื่อผู้บังคับบัญชา 1</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->sup_name . '';
$html .= '</td>';
$html .= '<th colspan="2" align="left" style="border: 1px solid #000000;">Supervisor Grade 1</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->sup_grade . '';
$html .= '</td>';
$html .= '</tr>';
$html .= '</div>';
$html .= '<div style="' . ($self_evaluation_ids->sup_name2 == "" ? "display: none;" : "") . '">';
$html .= '<tr>';
$html .= '<th colspan="2" align="left" style="border: 1px solid #000000;">Supervisor name 2 <br> ชื่อผู้บังคับบัญชา 2</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->sup_name2 . '';
$html .= '</td>';
$html .= '<th colspan="2" align="left" style="border: 1px solid #000000;">Supervisor Grade 2</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->sup_grade2 . '';
$html .= '</td>';
$html .= '</tr>';
$html .= '</div>';
$html .= '<tr>';
$html .= '<div style="' . ($self_evaluation_ids->foreman == "" ? "display: none;" : "") . '">';
$html .= '<th colspan="2" align="left" style="border: 1px solid #000000;">Foreman</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->foreman . '';
$html .= '</td>';
$html .= '</div>';
$html .= '<div style="' . ($self_evaluation_ids->factory_Manager_GM == "" ? "display: none;" : "") . '">';
$html .= '<th colspan="2" align="left" style="border: 1px solid #000000;">Factory Manager / GM</th>';
$html .= '<td colspan="2" style="border: 1px solid #000000;">';
$html .= '' . $self_evaluation_ids->factory_Manager_GM . '';
$html .= '</td>';
$html .= '</div>';
$html .= '</tr>';
$html .= '</table>';
...
$html .= '<b>Job Target : เป้าหมายงาน</b>';
$html .= '</td>';
$html .= '<td colspan="3" align="center">';
$html .= '<b>Actual achievement : ผลสำเร็จ</b>';
$html .= '</td>';
$html .= '</tr>';
...
$html .= '<tr>';
$html .= '<td colspan="3" align="center">';
$html .= '<b>What are your weaknesses? <br> จุดอ่อนของคุณคืออะไร?</b>';
$html .= '</td>';
$html .= '<td colspan="3" align="center">';
$html .= '<b>What are your strengths? <br> จุดแข็งของคุณคืออะไร?</b>';
$html .= '</td>';
$html .= '</tr>';
$html .= '<tr>';
