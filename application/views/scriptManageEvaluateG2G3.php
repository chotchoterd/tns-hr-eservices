<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn_copy').click(function() {
            ...
            if (year_from == year_to) {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php/manage_Self_Evaluation/Copy_evaluation_ItemG2G3') ?>",
                    dataType: "json",
                    type: "POST",
                    data: {
                        year_from: year_from,
                    ...
                    success: function(data) {
                        Swal.fire({
                            ...
                            window.location = '<?php echo base_url('index.php/manage_Self_Evaluation/ManageEvaluateG2G3'); ?>';
                        });
                    }
                });
            }
    ...
    function submit_evaluation_ItemG2G3() {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/manage_Self_Evaluation/submit_evaluation_ItemG2G3_ajax') ?>",
            type: "POST",
            dataType: "json",
            data: {
                year: year,
    ...
    function update_evaluation_ItemG2G3() {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/manage_Self_Evaluation/update_evaluation_ItemG2G3_ajax') ?>",
            type: "POST",
            dataType: "json",
            data: {
                up_id: up_id,
