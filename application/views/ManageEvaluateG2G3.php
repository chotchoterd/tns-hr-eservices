...
<div class="container mt-3">
    <table class="table table-form">
        <tr>
            <th class="topic-background mit border">Copy AA002-Bonus&Annual Evaluate G2-G3 - PMIS From</th>
...
<div class="container mt-3">
    <?php foreach ($bonus_evaluate_g2_g3_id as $bonus_evaluate_g2_g3_ids) {
        if (count($bonus_evaluate_g2_g3_id) != 0) {
            $update_indicator = 1;
        } else {
            $update_indicator = 0;
        }
    ...
    <table class="table table-form border">
        <tr>
            <th colspan="6" class="topic-background mit border h1">Manage AA003-Bonus-Annual Evaluate G2-G3 - PMIS</th>
        </tr>
        <tr>
        ...
        <tr>
            <td class="border mit-v td_border">
                <?php if ($update_indicator == 1) { ?>
                    <input type="hidden" name="up_id" id="up_id" value="<?php echo $bonus_evaluate_g2_g3_ids->id; ?>">
                    <select name="up_year" id="up_year" class="form-select">
                        <?php
                        $current_year = date('Y');
                        for ($y = $current_year - 5; $y < $current_year + 5; $y++) { ?>
                            <option value="<?php echo $y ?>" <?php if ($y == $bonus_evaluate_g2_g3_ids->year) echo "selected"; ?>><?php echo $y ?></option>
                        <?php } ?>
                    </select>
                <?php } else { ?>
            ...
            <td class="border mit-v td_border">
                <?php if ($update_indicator == 1) { ?>
                    <input type="number" class="form-control" id="up_topic" name="up_topic" min="0" value="<?php echo $bonus_evaluate_g2_g3_ids->topic; ?>">
            ...
            <td class="border mit-v td_border">
                <?php if ($update_indicator == 1) { ?>
                    <div class="form-floating">
                        <textarea name="up_evaluation_Item_en" id="up_evaluation_Item_en" class="form-control h-textarea" style="height: 100px;"><?php echo $bonus_evaluate_g2_g3_ids->evaluation_Item_en; ?></textarea>
            ...
            <td class="border mit-v td_border">
                <?php if ($update_indicator == 1) { ?>
                    <div class="form-floating">
                        <textarea name="up_evaluation_Item_th" id="up_evaluation_Item_th" class="form-control h-textarea" style="height: 100px;"><?php echo $bonus_evaluate_g2_g3_ids->evaluation_Item_th ?></textarea>
                        <label for="" class="font-twelve">
                            Please fill in !
                            <span class="red font-twelve">*</span>
                        </label>
            ...
            <td class="border mit-v td_border">
                <?php if ($update_indicator == 1) { ?>
                    <select name="up_status" id="up_status" class="form-select">
                        ...
                        <option value="1" <?php if ($bonus_evaluate_g2_g3_ids->status == "1") echo "selected"; ?>>Active</option>
                        <option value="0" <?php if ($bonus_evaluate_g2_g3_ids->status == "0") echo "selected"; ?>>Inactive</option>
                    </select>
    ...
    <table class="table table-form">
        ...
        <?php foreach ($bonus_evaluate_g2_g3 as $bonus_evaluate_g2_g3s) {
            ...
            <tr>
                ...
                <td class="border mit"><?php echo $bonus_evaluate_g2_g3s->topic; ?></td>
                <td class="border"><?php echo $bonus_evaluate_g2_g3s->evaluation_Item_en; ?></td>
                <td class="border"><?php echo $bonus_evaluate_g2_g3s->evaluation_Item_th; ?></td>
                <td class="border mit"><?php echo $bonus_evaluate_g2_g3s->year; ?></td>
                <td class="border mit">
                    <?php if ($bonus_evaluate_g2_g3s->status == "1") {
                        echo "Active";
                    } else {
                        echo "Inactive";
                    } ?>
                ...
                <td class="border mit">
                    <a href="<?php echo base_url('index.php/manage_Self_Evaluation/ManageEvaluateG2G3/?id=') ?><?php echo $bonus_evaluate_g2_g3s->id; ?>">Edit</a>
                </td>
            </tr>
        <?php } ?>
    </table>
