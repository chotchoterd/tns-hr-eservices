...
<div class="container-fluid mt-3">
    <table class="table table-form border-0">
        ...
        <?php foreach ($data_EvaluateG2G3_id as $data_EvaluateG2G3_ids) {
            if (count($data_EvaluateG2G3_id) != 0) {
                $update_indicator = 1;
            } else {
                $update_indicator = 0;
            }
    ...
    <table class="table table-form border">
        ...
        <tr>
            ...
            <td class="border td_border mit">
                <?php if ($update_indicator == 1) { ?>
                    <input type="hidden" id="up_id" name="up_id" value="<?php echo $data_EvaluateG2G3_ids->id ?>">
        ...
        <tr>
            ...
            <td style="width: 50%;" colspan="5" class="border td_border mit">
                <?php if ($update_indicator == 1) { ?>
                    ...
                    <b>
                        <div id="up_assessment_score"><?php echo $data_EvaluateG2G3_ids->assessment_score ?></div>
                    </b>
                <?php } else { ?>
    ...
    <table class="table table-form border-0">
        ...
        <tr>
            <?php if ($update_indicator == 1) { ?>
                ...
                <td class="border-0"><b>A </b><input type="checkbox" name="up_grade_a" id="up_grade_a" class="form-check-input" disabled <?php if ($data_EvaluateG2G3_ids->total_score >= 91) echo 'checked'; ?>> <label for="grade_a">91 Above /สูงกว่า 91</label></td>
                <td class="border-0"><b>B </b><input type="checkbox" name="up_grade_b" id="up_grade_b" class="form-check-input" disabled <?php if ($data_EvaluateG2G3_ids->total_score >= 73 && $data_EvaluateG2G3_ids->total_score <= 90) echo 'checked'; ?>> <label for="grade_b">90 - 73</label></td>
                <td class="border-0"><b>C </b><input type="checkbox" name="up_grade_c" id="up_grade_c" class="form-check-input" disabled <?php if ($data_EvaluateG2G3_ids->total_score >= 56 && $data_EvaluateG2G3_ids->total_score <= 72) echo 'checked'; ?>> <label for="grade_c">72 - 56</label></td>
                <td class="border-0"><b>D </b><input type="checkbox" name="up_grade_d" id="up_grade_d" class="form-check-input" disabled <?php if ($data_EvaluateG2G3_ids->total_score <= 55) echo 'checked'; ?>> <label for="grade_d">55 Below / ต่ำกว่า 55</label></td>
            <?php } else { ?>
                <td class="border-0">Grade / ระดับ</td>
