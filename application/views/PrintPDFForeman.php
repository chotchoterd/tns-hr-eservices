...
$html .= '<td align="left" style="border: 1px solid #000000; width: 130px;">';
$html .= '' . $data_EvaluateForeman_ids->date_submit . '';
$html .= '</td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Employee name</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
$html .= '' . $data_EvaluateForeman_ids->emp_name . '';
$html .= '</td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Employee ID</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
$html .= '' . $data_EvaluateForeman_ids->emp_id . '';
$html .= '</td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Position</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
$html .= '' . $data_EvaluateForeman_ids->position . '';
$html .= '</td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Section</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
$html .= '' . $data_EvaluateForeman_ids->section . '';
$html .= '</td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Employment date</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
$html .= '' . $data_EvaluateForeman_ids->employment_date . '';
$html .= '</td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Years of service</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
...
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Foreman</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
$html .= '' . $data_EvaluateForeman_ids->foreman . '';
$html .= '</td>';
$html .= '</div>';
$html .= '<div style="' . ($data_EvaluateForeman_ids->sup_name1 == "" ? "display: none;" : "") . '">';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Supervisor Name 1</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
$html .= '' . $data_EvaluateForeman_ids->sup_name1 . '';
$html .= '</td>';
$html .= '</div>';
$html .= '<div style="' . ($data_EvaluateForeman_ids->sup_name2 == "" ? "display: none;" : "") . '">';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Supervisor Name 2</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
...
$html .= '<tr>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 100px;"><b>Factory Manager / GM</b></td>';
$html .= '<td align="left" style="border: 1px solid #000000; width: 120px;">';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000000;">Leave day(s) – จำนวนวันลา</th>';
$html .= '<th style="border: 1px solid #000000; width: 100px;">0 – 6</th>';
$html .= '<th style="border: 1px solid #000000; width: 100px;">7 – 13</th>';
$html .= '<th style="border: 1px solid #000000; width: 100px;">14 – 20</th>';
$html .= '<th style="border: 1px solid #000000; width: 100px;">21 – 27</th>';
$html .= '<th style="border: 1px solid #000000;">28 days up/ 28วันขึ้นไป</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td align="center" style="border: 1px solid #000000;">40 points - 40 คะแนน</td>';
$html .= '<td align="center" style="border: 1px solid #000000;">40</td>';
$html .= '<td align="center" style="border: 1px solid #000000;">35</td>';
$html .= '<td align="center" style="border: 1px solid #000000;">30</td>';
$html .= '<td align="center" style="border: 1px solid #000000;">25</td>';
$html .= '<td align="center" style="border: 1px solid #000000;">0</td>';
$html .= '</tr>';
$html .= '</table>';
$html .= '<table>';
$html .= '<tr>';
$html .= '<th colspan="3" style="border: 1px solid #000; width: 225px;">';
$html .= 'Leave record between 1 Sep [YYYY] – 31 Aug [YYYY] <br>';
$html .= 'สถิติการลาระหว่าง 1 กันยายน [YYYY] ถึง 31 สิงหาคม [YYYY]';
$html .= '</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000; width: 225px;">Leave record. บันทึกการลา</th>';
$html .= '<th style="border: 1px solid #000; width: 225px;">';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000;">Business leave ลากิจ</th>';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000;">Sick leave ลาป่วย</th>';
$html .= '<td align="center" style="border: 1px solid #000;">';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000;">Absenteeism ขาดงาน</th>';
$html .= '<td align="center" style="border: 1px solid #000;">';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000;">Total รวม</th>';
$html .= '<td align="center" style="border: 1px solid #000;">';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000;">Grand Total ผลรวม</th>';
$html .= '<td align="center" colspan="2" style="border: 1px solid #000;">';
$html .= '' . $data_EvaluateForeman_ids->grand_total . '';
$html .= '</td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000;">Late มาสาย</th>';
$html .= '<td align="center" style="border: 1px solid #000;">';
...
$html .= '<table>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000; width: 300px;">Leave Score</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="background-color: #006494; color: #fff;">';
$html .= '<label for="">';
...
$html .= '<table>';
$html .= '<tr>';
$html .= '<th colspan="3" style="border: 1px solid #000;">';
$html .= 'การลงโทษทางวินัย / Punishment Record <br>';
$html .= 'ระหว่าง 1 Sep [YYYY] - 31 Aug [YYYY]';
$html .= '</th>';
$html .= '<th style="border: 1px solid #000; width: 150px;">หมายเหตุ / Noted</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td style="border: 1px solid #000;">ตักเตือนด้วยวาจา/Verbal Warning</td>';
...
$html .= '</td>';
$html .= '<td style="border: 1px solid #000;">ครั้ง</td>';
$html .= '<td style="border: 1px solid #000;">ไม่นำไปใช้ร่วมการประเมิน</td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td style="border: 1px solid #000;">ตักเตือนด้วยหนังสือ/Letter warning</td>';
$html .= '<td style="border: 1px solid #000;">';
...
$html .= '</td>';
$html .= '<td style="border: 1px solid #000;">ครั้ง</td>';
$html .= '<td style="border: 1px solid #000;">นำไปใช้ร่วมการประเมิน</td>';
$html .= '</tr>';
$html .= '</table>';
$html .= '</td>';
$html .= '</tr>';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000;">Evaluation Item / หัวข้อการประเมิน</th>';
$html .= '<th style="border: 1px solid #000;">Excellent<br>ดีเลิศ<br>(10)</th>';
$html .= '<th style="border: 1px solid #000;">Good<br>ดี<br>(8)</th>';
$html .= '<th style="border: 1px solid #000;">Fair<br>พอใช้<br>(5)</th>';
$html .= '<th style="border: 1px solid #000;">Need Improvemen<br>ต้องปรับปรุง<br>(3)</th>';
$html .= '<th style="border: 1px solid #000;">Un Satisfactory<br>ไม่เป็นที่พอใจ<br>(2)</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th align="left" style="border: 1px solid #000;">';
...
$html .= '<table>';
$html .= '<tr>';
$html .= '<th align="left" style="border: 1px solid #000; width: 350px;">Section Assessment score คะแนนประเมินโดยแผนก</th>';
$html .= '<th style="border: 1px solid #000; width: 350px;">';
$html .= '' . $data_EvaluateForeman_ids->assessment_score . '';
$html .= '</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th align="left" style="border: 1px solid #000; width: 350px;">Leave record score คะแนนจากสถิติการลา</th>';
$html .= '<th style="border: 1px solid #000; width: 350px;">';
$html .= '' . $data_EvaluateForeman_ids->leave_score . '';
$html .= '</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th align="left" style="border: 1px solid #000; width: 350px;">Total Score คะแนนรวม</th>';
$html .= '<th style="border: 1px solid #000; width: 350px;">';
...
$html .= '<table>';
$html .= '<tr>';
$html .= '<td colspan="5" class="border-0">Rating Score / ผลการประเมิน</td>';
$html .= '</tr>';
$html .= '<tr>';
...
$html .= '<td style="width: 140px;"><b>A </b><input type="checkbox" name="up_grade_a" id="up_grade_a" class="form-check-input" disabled ' . $grade_a_checked . '> <label for="grade_a">91 Above /สูงกว่า 91</label></td>';
$html .= '<td style="width: 140px;"><b>B </b><input type="checkbox" name="up_grade_b" id="up_grade_b" class="form-check-input" disabled ' . $grade_b_checked . '> <label for="grade_b">90 - 73</label></td>';
$html .= '<td style="width: 140px;"><b>C </b><input type="checkbox" name="up_grade_c" id="up_grade_c" class="form-check-input" disabled ' . $grade_c_checked . '> <label for="grade_c">72 - 56</label></td>';
$html .= '<td style="width: 140px;"><b>D </b><input type="checkbox" name="up_grade_d" id="up_grade_d" class="form-check-input" disabled ' . $grade_d_checked . '> <label for="grade_d">55 Below / ต่ำกว่า 55</label></td>';
$html .= '</tr>';
$html .= '</table>';
$html .= '<table>';
$html .= '<tr>';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th style="border: 1px solid #000; width: 240px;">Position /ตำแหน่ง</th>';
$html .= '<th style="border: 1px solid #000; width: 240px;">Final Rating</th>';
$html .= '<th style="border: 1px solid #000; width: 240px;">Comment in writing <br> ความคิดเห็นเป็นลายลักษณ์อักษร</th>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td style="height: 100px; border: 1px solid #000;">Direct Supervisor <br> หัวหน้างานสายตรง</td>';
$html .= '<td style="height: 100px; border: 1px solid #000; text-align: center;" rowspan="3">';
...
$html .= '</td>';
$html .= '<td style="height: 100px; border: 1px solid #000;" class="border mit-v"></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td style="height: 100px; border: 1px solid #000;" class="border mit-v">Senior Manager / Section Manager <br> ผู้จัดการอาวุโส / ผู้จัดการแผนก</td>';
$html .= '<td style="height: 100px; border: 1px solid #000;" class="border mit"></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<td style="height: 100px; border: 1px solid #000;" class="border mit-v">Factory Manager <br> ผู้จัดการโรงงาน</td>';
$html .= '<td style="height: 100px; border: 1px solid #000;" class="border mit"></td>';
$html .= '</tr>';
$html .= '</table>';
$html .= '' . br(2) . '';
...
$html .= '<table>';
$html .= '<tr>';
$html .= '<td style="vertical-align: bottom; border-bottom: 1px solid #000000; width: 200px;"></td>';
$html .= '</tr>';
$html .= '</table>';
$html .= '<br>';
$html .= '<label for="">(' . nbs(56) . ')</label><br>';
$html .= '<label for="" class="mit">Direct Supervisor</label><br>';
...
$html .= '<br>';
$html .= '<label for="">(' . nbs(56) . ')</label><br>';
$html .= '<label for="" class="mit">Senior Manager / Section Manager</label><br>';
