<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#bt_Save_Draft').click(function() {
            send_Save_Draft_SelfEvaluationForm();
        });
    ...
    function send_submit_SelfEvaluationForm() {
        ...
        let self_evaluation_status = "Submit";

        $.ajax({
            url: '<?php echo base_url(); ?>index.php/hr_controller/submit_self_evaluation_ajax',
            type: 'POST',
            dataType: 'json',
            data: {
            ...
            success: function(data) {
                Swal.fire({
                    ...
                    <?php if ($_SESSION["group"] == "") { ?>
                        window.location = '<?php echo base_url('index.php/hr_controller/TableRecordSelfEvaluation'); ?>';
                    <?php } else { ?>
    ...
    function send_Save_Draft_SelfEvaluationForm() {
        let year_submit = document.getElementById("year_submit").value;
        let date_submit = document.getElementById("date_submit").value;
        let emp_name = document.getElementById("emp_name").value;
        let emp_id = document.getElementById("emp_id").value;
        ...
        let your_feedback = document.getElementById("your_feedback").value;
        let emp_email = document.getElementById("emp_email").value;
        let self_evaluation_status = "Draft";
